...
public class TestAlghorithm : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       // ga = new GeneticAlgorithm<double>(populationSize,neuralNetworkSize, random, GetRandomDouble,FitnessFunction,elitism,newUnits mutationRate);
    }
